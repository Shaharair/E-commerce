            ...
            <Container>
                ...
                <form action="">
                        ...
                        <div className="flex justify-between flex-wrap">
                            ...
                            <div className="w-[50%]">
                                ...
                                <div className="border-b-2 mx-5">
                                    ...
                                    <input type="text" placeholder="Your phone number" className="font-sans font-medium text-[16px] text-[#767676] pb-[20px] outline-none" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="flex justify-between flex-wrap">
                                <div className="w-[50%]">
                                    <div className="border-b-2">
                                        ...
                                        <input type="text" placeholder="4279 Zboncak Port Suite 6212" className="font-sans font-medium text-[16px] text-[#767676] pb-[20px] outline-none" />
                                    </div>
                                    <div className="border-b-2">
                        ...
                        <div className="w-[70%]">
                            ...
                            <div className="flex justify-between">
                                <div className="w-[50%] border-b-2 relative">
                                    ...
                                    <input onChange={handlePassword} type={passwordShow ? "text" : "password"} placeholder="Password" className="font-sans font-medium text-[16px] text-[#767676] pb-[20px] pt-[10px] outline-none" />
                    ...
                    <div className="py-[100px]">
                        ...
                        <div className="">
                            <h3 className="font-sans font-semibold text-[18px] text-[#262626] w-[200px] h-[60px] border-2 border-[#262626] text-center leading-[60px] hover:bg-[#262626] hover:text-[white] duration-300 ease-in-out">Sing up</h3>
                        </div>
                    </div>
                </form>
            </Container>
