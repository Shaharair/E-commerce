        ...
        <Container>
            ...
            <div className="w-[50%]">
                ...
                <div className="border-b-2">
                    ...
                    <h4 className="font-sans font-medium text-[16px] text-[#767676] pb-[20px]">Your name here</h4>
                </div>
                <div className="border-b-2 pt-[50px]">
                    <h3 className="font-sans font-semibold text-[24px] text-[#262626] pb-[10px]">Email:</h3>
                    <h4 className="font-sans font-medium text-[16px] text-[#767676] pb-[20px]">Your email here</h4>
                </div>
                <div className="border-b-2 pt-[50px]">
                    <h3 className="font-sans font-semibold text-[24px] text-[#262626] pb-[10px]">Message:</h3>
                    <h4 className="font-sans font-medium text-[16px] text-[#767676] pb-[20px]">Your message here</h4>
                </div>
            </div>
